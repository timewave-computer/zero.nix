    ...
    solana-node = pkgs.stdenv.mkDerivation rec {
      ...
      solana-src = pkgs.fetchurl {
        ...
        sha256 = if pkgs.stdenv.isDarwin then
          ...
          "sha256-BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB=";  # Linux hash placeholder
      };
...
EOF
    ...
    anchor-wrapper = pkgs.writeShellScriptBin "anchor" ''
      ...
      # macOS-specific environment variables (from valence-solana)
  ...
  in {
    ...
    devShells.default = pkgs.mkShell {
      ...
      shellHook = ''
        ...
        export ANCHOR_VERSION="${anchor-version}"
        export SOLANA_VERSION="${sol-version}"
        export RUST_BACKTRACE="1"
        export PROTOC=${pkgs.protobuf}/bin/protoc
